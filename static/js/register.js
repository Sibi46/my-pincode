...
const TYPE_META = {
    company:             { label: 'Company',             icon: 'fa-building',      badge: 'blue',   org: 'Company Name',       desc: 'Start Promoting & Hiring — register your company today' },
    shop:                { label: 'Shop',                 icon: 'fa-store',         badge: 'purple', org: 'Shop Name',          desc: 'Start Promoting & Hiring — attract customers and the right staff' },
    ...
    factory:             { label: 'Factory',              icon: 'fa-industry',      badge: 'orange', org: 'Factory Name',       desc: 'Start Promoting & Hiring — find skilled workers for your factory' },
    startup:             { label: 'Startup',              icon: 'fa-rocket',        badge: 'red',    org: 'Startup Name',       desc: 'Start Promoting & Hiring — build your startup team from scratch' },
    institution:         { label: 'Institution',          icon: 'fa-university',    badge: 'blue',   org: 'Institution Name',   desc: 'Start Promoting & Hiring — connect with students and staff' },
    ...
    hospital:            { label: 'Hospital',             icon: 'fa-hospital',      badge: 'teal',   org: 'Hospital Name',      desc: 'Start Promoting & Hiring — recruit doctors, nurses & support staff' },
    hotel:               { label: 'Hotel / Restaurant',   icon: 'fa-hotel',         badge: 'gold',   org: 'Hotel / Rest. Name', desc: 'Start Promoting & Hiring — find the best hospitality staff' },
    farm:                { label: 'Farm',                  icon: 'fa-leaf',          badge: 'green',  org: 'Farm Name',          desc: 'Start Promoting & Hiring — connect with agricultural workers' },
